...
export const detailedVerbSet: Verb[] = [
    ...
    { id: 'GIVE', label: 'give', isNotForItems: true, requiresItem: true, preposition: 'to', defaultResponseWithItem: "They won't want this $ITEM.", defaultResponseCannotReach: "I cannot $VERB them the $ITEM from here.", isGiveVerb: true },
...
export const minimalVerbSet: Verb[] = [
    { id: 'WALK', label: 'walk to', isMoveVerb: true },
    { id: 'LOOK', label: 'look at', isLookVerb: true, defaultResponseNoItem: "I don't see anything special about it.", defaultResponseCannotReach: "I cannot see clearly from over here." },
    { id: 'USE', label: 'use', preposition: 'with', defaultResponseNoItem: "I can't do anything with $TARGET.", defaultResponseWithItem: "The $ITEM won't work on that.", isGiveVerb: true },
]
